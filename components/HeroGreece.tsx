...
// Place your background image at: /public/greece-hero.avif

const stats = [
  { value: "20+", label: "Universities" },
  { value: "EUR 4K to 10K", label: "Annual Tuition Fees" },
  { value: "1 year", label: "Post Study Work" },
];

export default function HeroGreece() {
  return (
    <section className="relative container mx-auto py-10">
      <div className="relative">
        <div className="relative aspect-[16/9] w-full overflow-hidden rounded-[2rem] sm:aspect-[21/9]">
          <Image
            src="/hero-greece.avif"
            alt="Acropolis of Athens, Greece"
            fill
            sizes="100vw"
          ...
          <div className="relative z-10 flex h-full flex-col justify-center px-6 pb-16 sm:px-10 md:px-16">
            ...
            <p className="mt-4 max-w-md text-sm font-semibold leading-relaxed text-white/90 sm:text-base">
              Study in Greece with Admission OnBoard. Get expert guidance on
