...
const steps = [
  {
    ...
    description:
      "Sit down with expert counsellors to explore your options, shortlist Maltese universities, and understand what's required.",
  },
  {
    title: "Confirm Your Admission",
    description:
      "Apply to your preferred institution in Malta and receive your official Letter of Acceptance.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Pay your tuition fees and secure your enrolment, then collect the documents your visa application will need.",
  },
  {
    title: "Apply For Your Student Visa & Prepare To Fly",
    description:
      "We help you lodge your Malta national (D-type) visa application, then it's time to prepare for departure to your new campus.",
  },
];
