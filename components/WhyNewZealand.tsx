...
const backupCountries = ["Australia", "United Kingdom", "Canada", "Malaysia"];
...
export default function WhyNewZealand() {
  return (
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1.3fr_1fr] md:gap-10">
          ...
          <div>
            <h2 className="text-3xl font-semibold tracking-tight text-[#1B1B1B] sm:text-4xl">
              Why <span className="text-[#E0483E]">New Zealand</span>?
            </h2>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-[#6B6B6B] sm:text-sm">
                  ...
                  clarity on studying in New Zealand.
                </p>
              </div>
            </div>
