...
const reasons = [
  {
    ...
    description:
      "Cyprus offers fully EU-recognized degrees at tuition fees significantly lower than the UK, Australia, or the US.",
    icon: (
      <path d="M12 3 2 8l10 5 8-4v6h2V8L12 3Zm0 8L4 8l8-4 8 4-8 4Zm-6 2v4c0 1.66 2.69 3 6 3s6-1.34 6-3v-4l-6 3-6-3Z" />
    ),
  },
  {
    title: "Widely Available English-Taught Programs",
    description:
      "Most universities teach entirely in English, so you can study a globally recognized degree without a language barrier.",
    icon: (
  ...
  {
    title: "Safe, Sunny Mediterranean Lifestyle",
    description:
      "One of Europe's safest countries, with year-round sunshine, warm beaches, and a relaxed pace of student life.",
    icon: (
  ...
  {
    title: "Strong in Business, Tourism & Shipping",
    description:
      "A recognized hub for maritime studies, tourism management, and business degrees, backed by real industry connections.",
    icon: (
...
const backupCountries = ["Malta", "Greece", "Hungary", "Romania"];
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1.3fr_1fr] md:gap-10">
          ...
          <div>
            <h2 className="text-3xl font-semibold tracking-tight text-[#1B1B1B] sm:text-4xl">
              Why <span className="text-[#E0483E]">Cyprus</span>?
            </h2>
