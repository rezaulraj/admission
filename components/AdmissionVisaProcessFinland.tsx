...
const steps = [
  {
    ...
    description:
      "Sit down with expert counsellors to explore your options, shortlist universities in Finland, and understand what's required.",
  },
  {
    title: "Confirm Your Admission",
    description:
      "Apply to your preferred institution in Finland and receive your official Letter of Acceptance.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Pay your tuition fees and secure your enrolment, then gather the documents your residence permit will need.",
  },
  {
    title: "Apply For Your Residence Permit & Prepare To Fly",
    description:
      "We help you apply for your Finnish residence permit for studies through Enter Finland, then it's time to prepare for departure to your new campus.",
  },
];
        ...
        <div className="mt-14 grid grid-cols-1 items-start gap-10 md:grid-cols-[1.1fr_1fr] md:gap-16">
          ...
          <div className="sticky top-24 hidden md:block">
            <div className="relative aspect-square w-full overflow-hidden rounded-2xl">
              <Image
                src="/admission-visa-finland.png"
