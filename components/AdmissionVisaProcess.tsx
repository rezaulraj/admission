...
const steps = [
  {
    ...
    description:
      "Sit down with expert counsellors to explore your options, shortlist universities, and understand what's required.",
  },
  {
    title: "Confirm Your Admission",
    description:
      "Apply to your preferred institution and receive your official offer letter.",
  },
  {
    title: "Submit Updated Documents",
    description:
      "Provide your latest academic and financial records for GS (Genuine Student) approval.",
  },
  {
    title: "Pay Tuition & Health Cover",
    description:
      "Secure your eCoE by paying tuition fees and arranging Overseas Student Health Cover (OSHC).",
  },
  {
    title: "Lodge Your Visa & Get Ready to Fly",
    description:
      "We help you lodge your visa application, then it's time to prepare for departure to your new campus.",
  },
];
