...
const steps = [
  {
    ...
    description:
      "Sit down with expert counsellors to explore your options, shortlist UK universities, and understand what's required.",
  },
  {
    title: "Confirm Your Admission",
    description:
      "Apply to your preferred UK institution and receive your official offer letter, conditional or unconditional.",
  },
  {
    title: "Submit Updated Documents",
    description:
      "Provide your latest academic and financial records so the university can issue your CAS (Confirmation of Acceptance for Studies).",
  },
  {
    title: "Pay Tuition & Receive Your CAS",
    description:
      "Pay your tuition deposit and receive your CAS number, the reference you'll need for your student visa application.",
  },
  {
    title: "Apply For Your Student Visa & Prepare To Fly",
    description:
      "We help you lodge your UK Student Route visa application, then it's time to prepare for departure to your new campus.",
  },
];
