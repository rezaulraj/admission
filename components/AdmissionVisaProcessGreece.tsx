...
const steps = [
  {
    ...
    description:
      "Sit down with expert counsellors to explore your options, shortlist universities in Greece, and understand what's required.",
  },
  {
    title: "Confirm Your Admission",
    description:
      "Apply to your preferred institution in Greece and receive your official Letter of Acceptance.",
  },
  {
  ...
  },
  {
    ...
    description:
      "We help you lodge your Greek national (D) visa application, then it's time to prepare for departure to your new campus.",
  },
];
