...
// Place your background image at: /public/new-zealand-hero.avif

const stats = [
  { value: "8+", label: "Universities" },
  { value: "NZD 22K to 35K", label: "Annual Tuition Fees" },
  { value: "2 to 3 years", label: "Post Study Work" },
];

export default function HeroNewZealand() {
  return (
        ...
        <div className="relative aspect-[16/9] w-full overflow-hidden rounded-[2rem] sm:aspect-[21/9]">
          ...
          <div className="relative z-10 flex h-full flex-col justify-center px-6 pb-16 sm:px-10 md:px-16">
            ...
            <p className="mt-4 max-w-md text-sm font-semibold leading-relaxed text-white/90 sm:text-base">
              Study in New Zealand with Admission OnBoard. Get expert guidance
              on admissions, scholarships, and visa support for a smooth study
              abroad journey.
            </p>
